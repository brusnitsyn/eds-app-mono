...
class Staff extends Model
{
    ...
    public function toSearchableArray(): array
    {
        return [
            ...
            'certification.valid_to' => !empty($this->certification) ? $this->certification->valid_to : null,
            'certification.close_key_valid_to' => !empty($this->certification) ? $this->certification->close_key_valid_to : null,
            'inn' => $this->inn,
            'snils' => $this->snils,
